  ...
  if (!src) {
    ...
    content = (
      <Image
        ...
        fill
        alt="thumbnail"
        className="object-cover transition-transform group-hover:translate-x-2 group-hover:translate-y-2 rouned-md"
      />
    );
  }

  return (
    <div className="group apsect-video relative rounded-md cursor-pointer">
